        ...
        <div class="flex items-center justify-between md:flex-1">
          ...
          @else
            ...
            <div
              ...
              <div class="flex space-x-4">
                <a href="{{ route('login') }}"
                  class="transform rounded-md px-3 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-200 hover:duration-300 dark:text-white dark:hover:bg-gray-900">
                  Login
                </a>
                <a href="{{ route('register') }}"
                  class="hidden transform rounded-md bg-indigo-700 px-3 py-2 text-sm font-medium text-white transition ease-out hover:bg-indigo-800 hover:duration-300 md:block">
                  Register
                </a>
              </div>
            </div>
